...
class SupportNotificationTemplatesSeeder extends Seeder
{
    /**
    ...
    {
       //added
        NotificationTemplate::updateOrCreate(['name' => 'notifications.support.customerSupport_created'], [
            'friendly_name' => 'New Customer Support Request',
            'title' => 'A new Support Customer Request has been added to the requsests',
            'body' => [
                ...
                'database' => '<p>A new Support Customer Request has been added to the requsests <a href="{customerSupports_Requests_link}">Here</a></p>'
