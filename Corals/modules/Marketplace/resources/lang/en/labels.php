...
return [
    ...
    'settings' => [
        ...
        'shipping' => [
            ...
            'no_available_shipping' => 'Sorry there is no available shipping methods for Store : :store, Product: <b> :products</b>',
            'is_shipping_per_product' => 'Is Shipping Per Product',
            'shippo_per_store' => 'Shippo account per Store',
        ],
    ...
    'product' => [
        ...
        'variations_create' => '<i class="fa fa-fw fa-plus"></i> New Variation',
       ...
       //our_change added
        ...
        'file_and_photos' => 'Files and Photos',
        'condition_and_price' => 'Condition and Price',
        'proof_of_origin'=>'Proof of Origin',
        'optional'=>'(Optional)',
        'certificate'=>'Certificate, invoice, serial number,...',
        'infoDownload'=>'This information will not be publicly displayed.',
        'photo'=>'Photos'
        //end
    ],
    'bulkGenerate' => [
    ...
    'checkout' => [
        ...
        'shipping_required' => 'Please contact seller because of missing shipping and remove it from your cart inorder to be able to proceed',
        ...
        'shipping_options' => 'Products: :products ',
        'sub_total' => 'Subtotal',
        'tax' => 'Tax',
        'discount' => 'Discount',
        'total' => 'Your Total',
    ...
    'package' => [
        'add_location' => '<i class="fa fa-plus"></i> Add Location',
        'remove_location' => '<i class="fa fa-times"></i> Remove',
        'product_shipping_options' => [
            'calculate_rates' => 'Calculate them for me',
            'flat_rate_prices' => "I'll enter flat rate prices manually",
        ],
    ],
];
