...
class Store
{
    ...
    public function createStore($user = null, Subscription $subscription = null)
    {
        ...
        $store->user_id = $user->id;
         //our_change customize store name
        $store->name = "Shand_".$user->id;//$user->full_name;
        if ($subscription) {
    ...
    public function getTransactionsSummary($user = null)
    {
        ...
        return compact('total_sales', 'total_commision', 'total_completed_withdrawals', 'total_pending_withdrawals',
            'balance');
    }
}
