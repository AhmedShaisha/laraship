...
class ProductsController extends BaseController
{
    ...
    public function create(ProductRequest $request)
    {
        ...
        //our_change
        $baseCategories = Category::Base()->pluck('id','name');
        $mainCategories = Category::Main()->pluck('id')->toArray();
        $categories_parent = Category::query()->pluck('parent_id','id');
        $adminApproved=$product->admin_approved;
        return view('Marketplace::products.create_edit')->with(compact('product', 'sku','baseCategories','mainCategories','categories_parent','adminApproved'));
    }
    ...
    public function store(ProductRequest $request)
    {
        try {
            ...
            return  redirectTo($this->resource_url . '/' . $product->hashed_id . '/edit');
    ...
    public function show(ProductRequest $request, Product $product)
    {
        ...
        //our_change
        $baseCategories = Category::Base()->pluck('id','name');
        return view('Marketplace::products.show')->with(compact('product','baseCategories'));
    }
    ...
    public function edit(ProductRequest $request, Product $product)
    {
        ...
        return view('Marketplace::products.create_edit')->with(compact('product', 'sku','adminApproved','baseCategories','mainCategories','categories_parent'));
    }
    ...
    //our_change
    public function catGallery(Request $request){
        $id = $request->cat_id;
        $images = [];
       ...
       if($category->hasMedia($category->galleryMediaCollection)){
            
        foreach($category->getMedia($category->galleryMediaCollection)  as $media ){
           $images[] = ['url'=>$media->getUrl(),'name'=>$media->getCustomProperty('name')];
