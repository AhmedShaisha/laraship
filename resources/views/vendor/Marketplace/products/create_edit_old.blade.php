        ...
        <div class="col-md-8">
            @component('components.box')
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li><a data-toggle="tab" href="#gallery-tab">@lang('Marketplace::labels.product.photo')</a></li>
                  </ul>
                ...
                <div class="tab-content">
                    ...
                    <div class="row">
                      <div class="col-md-6" >
                         ...
                         {{--   {!! CoralsForm::customField($product,'other_brand',$fieldClass = 'col-md-12')!!} --}}
                          {!! \Marketplace::getProdutcAttribute('Other Brand', $product->exists ? $sku : null )!!} 
                         </div>
                    ...
                    {{-- hana--}}
                        ...
                        <a class="pull-right btn btn-default btnNext" >@lang('Corals::labels.next')</a>
                ...
                <div id="menu1" class="tab-pane fade">
                    ...
                    <div class="row">
                        ...
                        {!! \Marketplace::getProdutcAttribute('Material', $product->exists ? $sku : null )!!} 
                                           
                        {{--   {!! CoralsForm::customField($product,'printed',$fieldClass = 'col-md-4')!!} --}}
                        {!! \Marketplace::getProdutcAttribute('Printed', $product->exists ? $sku : null )!!} 
                        </div>
                    </div>  
                    ...
                    <div class="row">
                        ...
                        {!! \Marketplace::getProdutcAttribute('Colour', $product->exists ? $sku : null )!!} 
                      </div> 
                    </div>  
                    ...
                    <div id="bag_size" class="hidden">
                      <div class="row">
                        ...
                        {!! \Marketplace::getProdutcAttribute('Width', $product->exists ? $sku : null )!!} 
                        {{--  {!! CoralsForm::customField($product,'height',$fieldClass = 'col-md-4')!!} --}}
                        {!! \Marketplace::getProdutcAttribute('Height', $product->exists ? $sku : null )!!} 
                        {{--   {!! CoralsForm::customField($product,'depth',$fieldClass = 'col-md-4')!!}  --}}
                        {!! \Marketplace::getProdutcAttribute('Depth', $product->exists ? $sku : null )!!} 
                        </div> 
                      </div>  
                    </div>
                    ...
                    <div id="cloth_size_international_value" class="hidden">
                      <div class="row">
                        ...
                        {!! \Marketplace::getProdutcAttribute('cloth Size International', $product->exists ? $sku : null )!!} 
                        </div>
                     </div>
                    </div>
                    ...
                    <div id="shoes_size_women" class="hidden">
                      <div class="row">
                        ...
                        {!! \Marketplace::getProdutcAttribute('Shoes Size Women', $product->exists ? $sku : null )!!} 
                        </div> 
                      </div> 
                    </div>
                    ...
                    <div id="shoes_size_men" class="hidden">
                      <div class="row">
                        ...
                        {!! \Marketplace::getProdutcAttribute('Shoes Size Men', $product->exists ? $sku : null )!!} 
                        </div> 
                      </div>  
                     </div>
                    ...
                    <div id="shoes_size_kids" class="hidden">
                      <div class="row">
                        ...
                        {!! \Marketplace::getProdutcAttribute('Shoes Size Kids', $product->exists ? $sku : null )!!} 
                        </div> 
                      </div>  
                    </div>
                <div >
                     ...
                     <a class="pull-right btn btn-default btnNext" >@lang('Corals::labels.next')</a>
                      <a class="pull-right btn btn-default btnPrevious" >@lang('Corals::labels.previous')</a>
                ...
                <div id="menu2" class="tab-pane fade">
                      ...
                      <div class="row">
                        ...
                        {!! \Marketplace::getProdutcAttribute('place of purchase', $product->exists ? $sku : null,['class'=>'form-check'] )!!} 
                        </div>
                      </div>
                      {{-- 
                     <div class="row">
                ...
                <div id="menu3" class="tab-pane fade">
                      ...
                      <div class="row">
                         ...
                         {!! \Marketplace::getProdutcAttribute('Condition', $product->exists ? $sku : null, ['inline'])!!} 
                         </div>
                        </div>
                      <div class="row">
                         <div class="col-md-12">
                          ...
                          <div class="col-md-6">
                            ...
                            {!! \Marketplace::getProdutcAttribute('Price For You', $product->exists ? $sku : null, ['id'=>'result1','left_addon'=>'<i class="'.$sku->currency_icon.'"></i>','readonly'] )!!} 
                          ...
                          <div class="col-md-6">
                            ...
                            {{--CoralsForm::text('saleprice_for_you','price for you',false,null,['id'=>'result2','readonly','left_addon'=>'<i class="'.$sku->currency_icon.'"></i>'])--}}
                            {!! \Marketplace::getProdutcAttribute('Sale Price For You', $product->exists ? $sku : null, ['id'=>'result2','left_addon'=>'<i class="'.$sku->currency_icon.'"></i>','readonly'] )!!} 
                       ...
                       {{--
                        <div id="variable_product_attributes" class="hidden">
                            {!! CoralsForm::select('variation_options[]','Marketplace::attributes.product.variation_options', \Marketplace::getAttributesList(),true,null,$product->admin_approved=='accepted'?[' readonly']:['multiple'=>true],$product->exists?'select':'select2') !!}
                             ...
                             <div class="row">
                             <div class="col-md-6">
                             {!! \Marketplace::getProdutcAttribute('Donation', $product->exists ? $sku : null )!!}
                             </div> 
                             </div>
              ...
              success:function (data) {
               ...
               $('#gallery-photo').append(
                '<div class="row" ><div class="col-md-12"><div class="col-md-6">'+
                        ...
                        ' <img src="'+image+'" class="img-responsive img-fluid" alt="category Gallery Image"/></div>'+
                        ' <div  class="panel-footer text-center font-weight-bold"><snap class="text-muted">Example</snap></div></div></div>'+
                        ...
                        '<div  class="panel-footer text-center font-weight-bold"><snap class="text-muted">Add Photo</snap></div></dive></div>'+
                        '</div></div>'
