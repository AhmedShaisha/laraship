...
return [
    ...
    'product' => [
        ...
        'more' => 'المزيد &rightarrow;',
         ...
         'file_and_photos' => 'الملفات والصور',
         'condition_and_price' => 'السعر و الشروط',
         'proof_of_origin'=>'اثبات طبق الأصل',
         'optional'=>'(حقل اختياري)',
         'certificate'=>'شهادة, فاتورة, رقم تسلسلي,...',
         'infoDownload'=>'لن تظهر هذه المعلومات للعامة ',
         'photo'=>'الصور'
         //end
    ],
    'checkout' => [
