...
@section('content_header')
    @component('components.content_header')
        ...
        @slot('breadcrumb')
            {{ Breadcrumbs::render('qualityTests_settings') }}
        @endslot
    @endcomponent
@endsection
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            @foreach ($settings as $setting_key => $setting_items)
                                ...
                                <div id="{{ $setting_key }}" class="tab-pane {{ $loop->first ? 'active' : '' }} ">
                                    <div class="row">
                                        <div class="col-md-10">
                                            {!! CoralsForm::openForm() !!}
                                            @foreach ($setting_items as $key => $setting)
                                                @php $setting_concat = 'quality_'.strtolower($setting_key).'_'.$key;  @endphp
