...
Route::group(['prefix' => 'marketplace', 'as' => 'marketplace.'], function () {
    ...
    //our_change 
        Route::group(['prefix' => 'categories', 'as' => 'category-gallery.'], function () {
                Route::get('{category}/gallery', ['as' => 'list', 'uses' => 'CategoriesController@gallery']);
                Route::post('{category}/gallery/upload', ['as' => 'upload', 'uses' => 'CategoriesController@galleryUpload']);
               //Route::post('{media}/gallery/mark-as-featured', ['as' => 'mark-as-featured', 'uses' => 'ProductsController@galleryItemFeatured']);
      
               Route::delete('{media}/gallery/delete', ['as' => 'delete', 'uses' => 'CategoriesController@galleryItemDelete']);
            });
...
//our_chang
Route::get('/catphotos', 'ProductsController@catGallery')->name('catphotos');
